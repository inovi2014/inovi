<?php
    ...
    class Crud
    {
        ...
        {
            $this->model    = $model;
            $config         = context('config')->load('crudjson');
        ...
        private function options($id, $plus = '')
        {
            ...
            $options .= '<td style="text-align: center;"><ul class="list-inline"><li><a rel="tooltip" title="afficher" class="btn btn-xs btn-info" href="/crud/json/read/table/' . $this->model->table . '/id/' . $id . '"><i class="fa fa-file"></i></a></li>';

            $options .= '<li><a rel="tooltip" title="dupliquer" class="btn btn-xs btn-warning" href="/crud/json/duplicate/table/' . $this->model->table . '/id/' . $id . '"><i class="fa fa-copy"></i></a></li>';

            $options .= '<li><a rel="tooltip" title="éditer" class="btn btn-xs btn-success" href="/crud/json/update/table/' . $this->model->table . '/id/' . $id . '"><i class="fa fa-edit"></i></a></li>';

            $options .= '<li><a rel="tooltip" title="supprimer" class="btn btn-xs btn-danger" href="#" onclick="if (confirm(\'Confirmez-vous la suppression de cet élément ?\')) document.location.href = \'/crud/json/delete/table/' . $this->model->table . '/id/' . $id . '\'; return false;"><i class="fa fa-trash-o"></i></a></li>' . $plus . '</ul></td>';
